...
#define BUZZER_PIN D2  // Cambiar el pin del buzzer según la conexión física
...
void procesarDatos(long bytesRecibidos) {
  // Definir el umbral de bytes para activar el buzzer
  long umbralBuzzer = 10000; // Ajusta este valor según las especificaciones de senior jaime
  
  // Verificar si la cantidad de bytes recibidos alcanza el umbral para activar el buzzer
  if (bytesRecibidos >= umbralBuzzer) {
    // Activar el buzzer
